...
<form role="form" method="post" action="livro-listar.php">
	...
	<div class="form-group">
		<label for="fautor"><i class="fa fa-user"></i> Nome do Autor</label>
		<input type="text" class="form-control" id="fautor" name="autor" placeholder="Nome Do Autor" value="<?php echo $autor; ?>" required>
	</div>    

	<div class="form-group">
		<label for="fdescricao"><i class="fa fa-comment"></i> Prévia</label>
	...
	<div class="row">
		<div class="form-group col-xs-4">
			<div class="form-group">
				<label for="feditora"><i class="fa fa-leaf"></i> Editora</label>
		...
		<div class="form-group col-xs-4">
			<div class="form-group">
				<label for="fexemplares"><i class="fa fa-database"></i> Exemplares</label>
	...
	<div class="row">
		...
		<div class="form-group col-xs-4">
			<label for="fdias_dev"><i class="fa fa-calendar"></i> Dias Disponíveis</label>
			<input type="number" class="form-control" id="fdias_dev" name="dias_dev" placeholder="Max.12 Dias" value="" min="1" max="12" required>
		</div>         
	</div>    
