      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="http://localhost/bbteca_ontheline/livro-update.php">
              ...
              <div class="form-group">
                  <label for="recipient-autor"><i class="fa fa-pencil-square-o"></i> Nome do Autor</label>
                  <input type="text" class="form-control" id="recipient-autor" name="autor">
              </div>    

              <div class="form-group">
                  <label for="recipient-desc"><i class="fa fa-pencil-square-o"></i> Prévia</label>
              ...
              <div class="row">
                  <div class="form-group col-xs-4">
                      <div class="form-group">
                          <label for="recipient-editora"><i class="fa fa-pencil-square-o"></i> Editora</label>
                  ...
                  <div class="form-group col-xs-4">
                      <div class="form-group">
                          <label for="recipient-exemplares"><i class="fa fa-pencil-square-o"></i> Exemplares</label>
...
<div class="panel panel-default ">
  ...
  <table class="table table-striped table-hover">
    ...
    <tbody>
      <?php
        $sql = "Select cod_livro, titulo, autor, descricao, editora, edicao, exemplares, multa_atraso, status from livros";
        $array = array();
        if($q != ''){
